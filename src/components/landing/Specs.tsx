...
const specs = [
  {
    ...
    value: 104, 
    suffix: " HP",
    desc: "Công suất cực đại tại 6000 RPM",
  },
  {
    icon: Activity,
    label: "Mô-men xoắn",
  ...
  },
  {
    ...
    value: 175,
    suffix: " km/h",
    desc: "Tốc độ trung bình trên XL7/Ertiga",
  },
  {
    icon: Flame,
    ...
    suffix: "s",
    decimals: 1,
    desc: "Động cơ hút khí tự nhiên (N/A)",
  },
  {
    icon: Wind,
    label: "Dung tích",
    ...
    suffix: "L",
    decimals: 1,
    desc: "I4 DOHC 16 Van, công nghệ VVT",
  },
  {
    icon: Cog,
    label: "Tỷ số nén",
    ...
    suffix: ":1",
    decimals: 1,
    desc: "Phun xăng điện tử đa điểm (MPI)",
  },
];
